...
function Footer() {
  return (
    <footer className="bg-[#011C2B] text-white text-center py-4">
      ...
      {/* Topicos lado a lado */}
      <div className="mt-5 w-full max-w-[1230px] mx-auto flex flex-col md:flex-row items-start justify-start gap-16 px-4 text-left">
        {/* Fale Conosco */}
        <div>
        ...
        {/* Redes Sociais */}
        <div className="bg-[#131313] p-8 border-1-black rounded-md ml-60">
          <div className="flex justify-center items-center">
            <h1 className="text-lg font-bold mb-1">
              Nos Siga na Redes Sociais
            </h1>
          </div>
          <div className="bg-[#555555] mt-5 w-70 flex justify-center items-center  gap-5 px-2 py-1 border-1-black rounded-md">
            <div className="flex items-center gap-2 text-sm mt-3">
